            ...
            <div className="overflow-hidden" ref={emblaRef}>
              <div className="flex">
                {testimonialImages.map((image, index) => (
                  <div 
                    key={index} 
                    className="flex-[0_0_55%] sm:flex-[0_0_45%] md:flex-[0_0_40%] min-w-0 px-2"
                  >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <Button 
              variant="cta" 
              size="lg" 
              className="text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 animate-zoom-breath bg-green-600 hover:bg-green-700"
              onClick={scrollToOffer}
            >
